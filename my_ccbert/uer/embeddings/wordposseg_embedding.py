...
class WordPosSegEmbedding(WordPosEmbedding):
    ...
    def __init__(self, args, vocab_size):
        ...
        # self.segment_embedding = nn.Embedding(3, args.emb_size) ## original BERT in UER
        self.segment_embedding = nn.Embedding(5, args.emb_size) ## only for Codebert because it only has 2 segments
