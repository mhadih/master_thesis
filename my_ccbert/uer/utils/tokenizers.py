...
def encode_pieces_simple(sp_model, text, return_unicode=True, sample=False):
    if not sample:
...
class BertTokenizer(Tokenizer):
    ...
    def tokenize(self, text):
        if self.sp_model:
            ...
            #split_tokens = encode_pieces_simple(self.sp_model, text, return_unicode=False) ## do not consider sentences
        else:
            split_tokens = []
